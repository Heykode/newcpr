...
fn source_tree_should_match_frozen_machine_manifest() {
    ...
    let mut expected = vec![
        ...
        "src/admin/outbound_user_agent.rs",
        ...
        "src/openai/chat/mod.rs",
        "src/openai/compact/mod.rs",
        "src/openai/encoding.rs",
        "src/openai/error.rs",
        "src/openai/images/http.rs",
        "src/openai/images/mod.rs",
        "src/openai/images/multipart.rs",
        "src/openai/mod.rs",
...
fn test_tree_should_match_frozen_rust_mirror() {
    ...
    let mut expected = vec![
        ...
        "tests/admin/request_capture.rs",
        ...
        "tests/openai/compact/mod.rs",
        "tests/openai/error.rs",
        "tests/openai/images/mod.rs",
        "tests/openai/images/multipart.rs",
        "tests/openai/mod.rs",
        "tests/openai/models.rs",
        "tests/openai/endpoint.rs",
        "tests/openai/responses/http.rs",
        "tests/openai/responses/chat.rs",
        "tests/openai/responses/capacity.rs",
        "tests/openai/responses/chat_cpa.rs",
