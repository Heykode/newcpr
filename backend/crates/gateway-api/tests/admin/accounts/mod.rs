    ...
    fn account_turn_state_projection_serializes_only_safe_slot_metadata() {
        let value = serde_json::to_value(AccountTurnStateView {
            ...
            models: vec![AccountTurnStateModelStatusView {
                ...
                probe_attempts: 11,
                probe_total_attempts: 456,
                probe_cooldown_until: Some("2026-09-18T12:30:00+08:00".to_owned()),
                probe_retry_from_upstream: Some(true),
                probe_http_status: Some(429),
                probe_error_code: Some("rate_limit_exceeded".to_owned()),
                probe_returned_length: Some(356),
        ...
        assert_eq!(
            ...
            json!({
                ...
                "models": [{
                    ...
                    "probeCooldownUntil": "2026-09-18T12:30:00+08:00",
