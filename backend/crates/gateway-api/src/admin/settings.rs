...
use gateway_admin::model::settings::{
    ModelMappings as DomainModelMappings, ReplaceRuntimeSettings, RequestTuningOverrides,
...
impl UpdateRuntimeSettingsRequest {
    ...
    pub fn validate(&self) -> Result<(), WireValidationError> {
        ...
        if !self.request_tuning.validate() {
            return Err(WireValidationError::new("requestTuning"));
        }
        validate_optional_client_version(
