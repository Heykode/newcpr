...
pub(crate) const fn store_diagnostic_dimension(
    ...
    match dimension {
        ...
        admin_observability::DiagnosticDimension::KeyModel => DiagnosticDimension::KeyModel,
...
pub(crate) fn admin_ops_error(error: OpsErrorRecord) -> admin_observability::OpsError {
    admin_observability::OpsError {
        ...
        effective_reasoning_effort: error.effective_reasoning_effort,
...
pub(crate) fn usage_list_record_from_row(
    ...
    Ok(UsageListRecord {
        ...
        effective_reasoning_effort: get(row, "effective_reasoning_effort")?,
