...
fn to_core_request_tuning(
    overrides: RequestTuningOverrides,
) -> gateway_core::routing::RequestTuning {
    let defaults = gateway_core::routing::RequestTuning::default();
    gateway_core::routing::RequestTuning {
        max_account_switches: overrides
            .max_account_switches
            .unwrap_or(defaults.max_account_switches),
        max_request_attempts: overrides
            .max_request_attempts
            .unwrap_or(defaults.max_request_attempts),
        websocket_max_retries: overrides
            .websocket_max_retries
            .unwrap_or(defaults.websocket_max_retries),
        ...
        websocket_stream_idle_timeout_ms: overrides
            .websocket_stream_idle_timeout_ms
            .unwrap_or(defaults.websocket_stream_idle_timeout_ms),
        websocket_failure_threshold: overrides
            .websocket_failure_threshold
            .unwrap_or(defaults.websocket_failure_threshold),
        websocket_failure_window_ms: overrides
            .websocket_failure_window_ms
            .unwrap_or(defaults.websocket_failure_window_ms),
        websocket_failure_open_duration_ms: overrides
            .websocket_failure_open_duration_ms
            .unwrap_or(defaults.websocket_failure_open_duration_ms),
        ...
        account_busy_wait_sticky_max_waiting: overrides
            .account_busy_wait_sticky_max_waiting
            .unwrap_or(defaults.account_busy_wait_sticky_max_waiting),
        account_busy_wait_sticky_timeout_seconds: overrides
            .account_busy_wait_sticky_timeout_seconds
            .unwrap_or(defaults.account_busy_wait_sticky_timeout_seconds),
        account_busy_wait_fallback_max_waiting: overrides
            .account_busy_wait_fallback_max_waiting
            .unwrap_or(defaults.account_busy_wait_fallback_max_waiting),
        account_busy_wait_fallback_timeout_seconds: overrides
            .account_busy_wait_fallback_timeout_seconds
            .unwrap_or(defaults.account_busy_wait_fallback_timeout_seconds),
    }
}
