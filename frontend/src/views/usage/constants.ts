...
import type { ConfigurableTableColumn } from '@/components/base/BaseTable/useTableColumns'
import { formatProvider } from './utils/format'

type OpsErrorRow = OpsError

export const usageRecordColumns: ConfigurableTableColumn<UsageDisplayRecord>[] = [
  {
    key: 'accountEmail',
    hideable: false,
    label: '账号',
